...
(function() {
    ...
    window._rainbowNameEnabled = localStorage.getItem('weyno-rainbowname-enabled') === 'true';
    window.addEventListener('rainbowNameToggleChanged', function(e) {
        window._rainbowNameEnabled = e.detail.value;
        // Принудительно обновить имя игрока (если ты уже в игре)
        if (window._0x12190 && window._0x12190.playerId) {
            var player = window._0x12190.playerRegistry.getPlayerById(window._0x12190.playerId);
            if (player) player.cacheUpdate = true;
        }
    });
    function _0x111D7(_0x11205, _0x11261, _0x1124A) {
        ...
        var _0x1121C = this.location.href.split("://")[1].split("/")[0].split(":")[0];
        var _0x111D7 = _0x11205.split(",");
        for (var _0x11233 = 0; _0x11233 < _0x111D7.length; _0x11233++) {
            ...
            _0x111EE = _0x1121C.split("." + _0x111EE);
            if (_0x111EE.length == 2 && !_0x111EE[1]) {
                return
            }
        };
        throw (_0x1124A || "error")
    }
    ...
    function _0x1121C() {
        ...
        function _0x12722() {
            ...
            var _0x11261 = _0x12190.scale_base * _0x12190.mouseZoom;
            _0x12190.scale = (9 * _0x12190.scale + _0x11261) / 10;
            _0x11EC7.scale.x = _0x12190.scale;
            _0x11EC7.scale.y = _0x12190.scale;
        ...
        _0x115CB.prototype.connect = function (_0x111EE) {
            ...
            this.socket[_0x111C0[365]] = function (_0x11205) {
                _0x111D7.reset();
                this.nextUrl = null;
                ...
                if (_0x111D7 || this.nameCache == null) {
                    ...
                    if (!this.nameCache) {
                        this.nameCache = new _0x1214B.Text(this.name, {
                            ...
                            fill: (window._rainbowNameEnabled && this.playerId === window._0x12190.playerId)
                        ...
                        this.nameCache.style.fill = (window._rainbowNameEnabled && this.playerId === window._0x12190.playerId)
                            ? ["#ff0000", "#ffff00", "#00ff00", "#00ffff", "#0000ff", "#ff00ff", "#ff0000"]
                            : this.nameColor;
        ...
        function _0x1156F(_0x111EE) {
            ...
            for (var _0x11205 in _0x12190.bucket) {
                _0x11233 = _0x12190.bucket[_0x11205];
                if (_0x11233.size < 25) {
                    continue
                };
